...
Suppose we could draw $K_{5,5}$ on the torus without edge crossings. Then $V = 5 + 5 = 10$ and $E = 5 \times 5 = 25$. Any face containing exactly 3 edges is a triangle, but $K_{5,5}$ does not contain any triangles (this is true of all $K_{t,t}$). So every face in a drawing of $K_{5,5}$ must contain at least 4 edges. Hence we have
