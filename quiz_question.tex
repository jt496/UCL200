...
We also need to use the fact that if a graph has at least 3 vertices and is \emph{connected} (this just means we can travel between any two vertices by following edges) then
